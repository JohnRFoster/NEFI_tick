...
create_ncdf_tick <- function(ncfname, pred, start.date, n.days, Nmc, data_assimilation, weights,
  ...
  def_list[[5]] <- ncvar_def(name =  "data_assimilation",
                             ...
                             prec = "single")
  def_list[[6]] <- ncvar_def(name = "particle_weight",
  ...
  ncvar_put(ncout, def_list[[2]], pred[1, , ])
  ncvar_put(ncout, def_list[[3]], pred[2, , ])
  ncvar_put(ncout, def_list[[4]], pred[3, , ])
  ncvar_put(ncout, def_list[[5]], data_assimilation)
  ncvar_put(ncout, def_list[[6]], weights)
