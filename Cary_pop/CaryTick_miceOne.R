...
inits <- function(){list(phi.l.mu = rnorm(1, 0, 1),
                         phi.n.mu = rnorm(1, 0, 1),
                         phi.a.mu = rnorm(1, 0, 1),
                         grow.ln.mu = rnorm(1, 0, 1),
                         grow.na.mu = rnorm(1, 0, 1),
                         repro.mu = rnorm(1, 0, 1),
                         beta.pl = rnorm(1, 0, 1),
                         beta.pn = rnorm(1, 0, 1),
                         beta.pa = rnorm(1, 0, 1),
                         beta.gln = rnorm(1, 0, 1),
                         beta.gna = rnorm(1, 0, 1),
                         beta.r = rnorm(1, 0, 1))}
...
saveRDS(jags.out,
        file = paste("/projectnb/dietzelab/fosterj/Previous_Runs_Tick/CaryTick_MiceOne_", xx, ".rds",
                     sep = ""))
