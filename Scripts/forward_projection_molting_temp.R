...
pred.D <- forecast_with_molting_temp(type = "deterministic",
                                     site = "Henry Control",
                                     params = params.mat,
                                     ic = ic.mat,
                                     N_est = N_est,
...
plot(1:N_est, pred.D[1,,], type = "l", xaxt = "n", main = "Larvae",ylim = ylim.larv)
axis(1, at = at, labels = ym.seq[at])

plot(1:N_est, pred.D[2,,], type = "l", xaxt = "n", main = "Nymph",ylim = ylim.nymph)
axis(1, at = at, labels = ym.seq[at])

plot(1:N_est, pred.D[3,,], type = "l", xaxt = "n", main = "Adult",ylim = ylim.adult)
axis(1, at = at, labels = ym.seq[at])


# Parameter Uncertainty
forecast.P <- forecast_with_molting_temp(type = "parameter",
                                     site = "Henry Control",
                                     params = params.mat,
                                     ic = ic.mat,
                                     N_est = N_est,
...
predict.P <- predict_state_one_temp(type = "parameter",
                                            site = "Henry Control",
                                            params = params.mat,
                                            ic = ic.mat,
                                            data = data,
...
forecast.P.IC <- forecast_with_molting_temp(type = c("parameter", "ic"),
                                         site = "Henry Control",
                                         params = params.mat,
                                         ic = ic.mat,
                                         N_est = N_est,
...
predict.P.IC <- predict_state_one_temp(type = c("parameter", "ic"),
                                    site = "Henry Control",
                                    params = params.mat,
                                    ic = ic.mat,
                                    data = data,
...
plot_run(time.all, CI.P.predict$Adult, "Adult", ylim = c(0,200))
...
# Parameter + IC Uncertainty
pred.P.IC <- forecast_with_molting_temp(type = c("parameter", "ic"),
                                     site = "Henry Control",
                                     params = params.mat,
                                     ic = ic.mat,
                                     N_est = N_est,
...
# Parameter + IC + Process Uncertainty
pred.P.IC.PROC <- forecast_with_molting_temp(type = c("parameter", "ic", "process"),
                                     site = "Henry Control",
                                     params = params.mat,
                                     ic = ic.mat,
                                     N_est = N_est,
...
plot(1:N_est, CI.P.IC.PROC$Larvae[2,], type = "l", xaxt = "n", xlab = "", main = "Larvae", ylim = c(0, 1000))
...
# Process Uncertainty
#source("Functions/forecast_with_molting_temp.R")
pred.PROC <- forecast_with_molting_temp(type = c("parameter", "ic", "process"),
                                     site = "Henry Control",
                                     params = params.mat,
                                     ic = ic.mat,
                                     N_est = N_est,
...
par(mfrow = c(3,1))
plot(1:N_est, CI.PROC$Larvae[2,], type = "l", xaxt = "n", main = "Larvae", ylim = c(0, 2100))
...
plot(1:N_est, CI.PROC$Adult[2,], type = "l", xaxt = "n", main = "Adult", ylim = c(0,60))
